...
if not os.path.exists(script_file_path):
    ...
    command_list = [ script_file_path, "-p", "-iterations", "100", "Scene.main.mdl" ]
    ...
    sp = Popen ( command_list, cwd=".", stdin=PIPE, stdout=PIPE, stderr=None, bufsize=0, close_fds=ON_POSIX)
    q = Queue()
