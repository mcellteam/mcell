...
*************************************************************************/
int test_many_reactions_all_neighbors(struct storage *local, struct rxn **rx, double *scaling, double *local_prob_factor, int n, int *chosen_pathway)
{
  ...
  if (n==1) return test_bimolecular(local, rx[0],scaling[0],local_prob_factor[0],NULL, NULL);
