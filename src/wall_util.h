...
void closest_pt_point_triangle(struct vector3 *p, struct vector3 *a, 
    struct vector3 *b, struct vector3 *c, struct vector3 *final_result);

int test_sphere_triangle(struct vector3 *s, double radius, struct vector3 *a, 
    struct vector3 *b, struct vector3 *c, struct vector3 *p);
...
int surface_point_in_region(struct volume *world, struct object *ob,
...
struct wall_list* find_nbr_walls_shared_one_vertex(struct volume *world, 
    struct wall *origin, int  *shared_vert);
