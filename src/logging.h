...
void mcell_perror(int err, char const *fmt, ...)
  PRINTF_FORMAT(2) __attribute__((noreturn));
...
void mcell_perrorv(int err, char const *fmt, va_list args)
  PRINTF_FORMAT_V(2) __attribute__((noreturn));
