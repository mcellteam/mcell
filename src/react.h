...
/* In react_trig.c */
struct rxn* trigger_unimolecular(struct rxn **reaction_hash, 
    int hashsize, u_int hash,struct abstract_molecule *reac);
...
int trigger_surface_unimol(struct rxn **reaction_hash, int rx_hashsize,
    ...
    struct species *all_surface_mols, struct abstract_molecule *reac,
    struct wall *w, struct rxn **matching_rxns);

int trigger_bimolecular_preliminary(struct rxn **reaction_hash, 
    int hashsize, u_int hashA,u_int hashB, struct species *reacA,
    struct species *reacB);

int trigger_trimolecular_preliminary(struct rxn **reaction_hash,
    int hashsize, u_int hashA, u_int hashB, u_int hashC,
...
int trigger_intersect(struct rxn **reaction_hash, int rx_hashsize,
    ...
    struct wall *w, struct rxn **matching_rxns, int allow_rx_transp, 
...
int find_surface_mol_reactions_with_surf_classes(struct rxn **reaction_hash,
    int rx_hashsize, struct species *all_mols, 
...
int find_volume_mol_reactions_with_surf_classes(struct rxn **reaction_hash,
    int rx_hashsize, struct species *all_mols, 
...
int determine_molecule_region_topology(struct volume *world, 
...
bool product_tile_can_be_reached(struct wall *target, 
    struct region_list *rlp_head_wall_1, struct region_list *rlp_head_wall_2,
    struct region_list *rlp_head_obj_1, struct region_list *rlp_head_obj_2,
