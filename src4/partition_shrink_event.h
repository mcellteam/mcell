...
#ifndef SRC4_PARTITION_SHRINK_EVENT_H_
#define SRC4_PARTITION_SHRINK_EVENT_H_
...
public:
  PartitionShrinkEvent(World* world_)
    : BaseEvent(EVENT_TYPE_INDEX_PARTITION_SHRINK),
      world(world_) {
  }
...
#endif // SRC4_PARTITION_SHRINK_EVENT_H_
