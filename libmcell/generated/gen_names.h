...
const char* const NAME_NEW_FWD_RATE = "new_fwd_rate";
const char* const NAME_NEW_REV_RATE = "new_rev_rate";
...
const char* const NAME_SET_REACTION_RULE_RATE = "set_reaction_rule_rate";
