...
const char* const NAME_CHECKPOINTED_SURFACE_MOLECULES = "checkpointed_surface_molecules";
const char* const NAME_CHECKPOINTED_VOLUME_MOLECULES = "checkpointed_volume_molecules";
...
const char* const NAME_RNG_STATE = "rng_state";
