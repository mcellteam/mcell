...
const char* const NAME_COUNT_TERMS_INCLUDE = "count_terms_include";
const char* const NAME_COUNT_TERMS_SUBTRACT = "count_terms_subtract";
...
const char* const NAME_ENCLOSED_IN_OBJECT = "enclosed_in_object";
