...
const char* const NAME_CLASS_BASE_CHKPT_MOL = "BaseChkptMol";
const char* const NAME_CLASS_BNGL_UTILS = "bngl_utils";
const char* const NAME_CLASS_CHKPT_SURF_MOL = "ChkptSurfMol";
const char* const NAME_CLASS_CHKPT_VOL_MOL = "ChkptVolMol";
const char* const NAME_CLASS_COLOR = "Color";
...
const char* const NAME_CLASS_MOL_WALL_HIT_INFO = "MolWallHitInfo";
const char* const NAME_CLASS_NOTIFICATIONS = "Notifications";
const char* const NAME_CLASS_OBSERVABLES = "Observables";
const char* const NAME_CLASS_REACTION_INFO = "ReactionInfo";
...
const char* const NAME_CLASS_RNG_STATE = "RngState";
const char* const NAME_CLASS_RUN_UTILS = "run_utils";
...
const char* const NAME_CLASS_WALL = "Wall";
const char* const NAME_CLASS_WALL_WALL_HIT_INFO = "WallWallHitInfo";
...
const char* const NAME_ADD_INSTANTIATION = "add_instantiation";
...
const char* const NAME_ALPHA = "alpha";
const char* const NAME_APPEND_TO_COUNT_OUTPUT_DATA = "append_to_count_output_data";
...
const char* const NAME_BB = "bb";
const char* const NAME_BIRTHDAY = "birthday";
const char* const NAME_BLUE = "blue";
const char* const NAME_BNG_VERBOSITY_LEVEL = "bng_verbosity_level";
const char* const NAME_BOND = "bond";
const char* const NAME_CC = "cc";
...
const char* const NAME_CHECKPOINTED_MOLECULES = "checkpointed_molecules";
const char* const NAME_COLLECT_WALL_WALL_HITS = "collect_wall_wall_hits";
const char* const NAME_COLOR = "color";
...
const char* const NAME_CONTINUE_AFTER_SIGALRM = "continue_after_sigalrm";
const char* const NAME_CONTINUE_SIMULATION = "continue_simulation";
...
const char* const NAME_EXPRESSION = "expression";
const char* const NAME_FILE = "file";
const char* const NAME_FILE_NAME = "file_name";
const char* const NAME_FIND_COUNT = "find_count";
...
const char* const NAME_FIND_SURFACE_COMPARTMENT_OBJECT = "find_surface_compartment_object";
const char* const NAME_FIND_VOLUME_COMPARTMENT_OBJECT = "find_volume_compartment_object";
...
const char* const NAME_GET_LAST_CHECKPOINT_DIR = "get_last_checkpoint_dir";
...
const char* const NAME_GET_WALL_COLOR = "get_wall_color";
const char* const NAME_GET_WALL_UNIT_NORMAL = "get_wall_unit_normal";
const char* const NAME_GREEN = "green";
const char* const NAME_GRID_TILE_INDEX = "grid_tile_index";
const char* const NAME_HIGH_REACTION_PROBABILITY = "high_reaction_probability";
const char* const NAME_ID = "id";
const char* const NAME_INITIAL_COLOR = "initial_color";
...
const char* const NAME_INSTANTIATION = "instantiation";
const char* const NAME_INTERACTION_RADIUS = "interaction_radius";
const char* const NAME_INTERMEMBRANE_INTERACTION_RADIUS = "intermembrane_interaction_radius";
const char* const NAME_IS_BNGL_COMPARTMENT = "is_bngl_compartment";
...
const char* const NAME_LOAD_BNGL_COMPARTMENTS_AND_SEED_SPECIES = "load_bngl_compartments_and_seed_species";
...
const char* const NAME_PRINT_COPYRIGHT = "print_copyright";
...
const char* const NAME_REACTION_CLASS_CLEANUP_PERIODICITY = "reaction_class_cleanup_periodicity";
const char* const NAME_REACTION_RULE = "reaction_rule";
const char* const NAME_REACTION_RULES = "reaction_rules";
const char* const NAME_RED = "red";
const char* const NAME_REGION = "region";
const char* const NAME_REGISTER_MOL_WALL_HIT_CALLBACK = "register_mol_wall_hit_callback";
const char* const NAME_REGISTER_REACTION_CALLBACK = "register_reaction_callback";
...
const char* const NAME_RXN_PROBABILITY_CHANGED = "rxn_probability_changed";
const char* const NAME_S = "s";
const char* const NAME_SAVE_CHECKPOINT = "save_checkpoint";
const char* const NAME_SC = "sc";
const char* const NAME_SCHEDULE_CHECKPOINT = "schedule_checkpoint";
const char* const NAME_SEED = "seed";
const char* const NAME_SET_WALL_COLOR = "set_wall_color";
const char* const NAME_SHAPE = "shape";
const char* const NAME_SIMULATION_METHOD = "simulation_method";
...
const char* const NAME_SPECIES_CLEANUP_PERIODICITY = "species_cleanup_periodicity";
const char* const NAME_SPECIES_ID = "species_id";
...
const char* const NAME_SURFACE_COMPARTMENT_NAME = "surface_compartment_name";
...
const char* const NAME_ENUM_REACTION_TYPE = "ReactionType";
...
const char* const NAME_EV_FLUX_CLAMP = "FLUX_CLAMP";
...
const char* const NAME_EV_NF = "NF";
const char* const NAME_EV_NONE = "NONE";
const char* const NAME_EV_NOT_SET = "NOT_SET";
const char* const NAME_EV_ODE = "ODE";
const char* const NAME_EV_PLA = "PLA";
...
const char* const NAME_EV_SSA = "SSA";
const char* const NAME_EV_SUB = "SUB";
const char* const NAME_EV_SURFACE = "SURFACE";
const char* const NAME_EV_SURFACE_SURFACE = "SURFACE_SURFACE";
const char* const NAME_EV_TRANSPARENT = "TRANSPARENT";
const char* const NAME_EV_UNIMOL_SURFACE = "UNIMOL_SURFACE";
const char* const NAME_EV_UNIMOL_VOLUME = "UNIMOL_VOLUME";
const char* const NAME_EV_UNION = "UNION";
const char* const NAME_EV_UNSET = "UNSET";
const char* const NAME_EV_UP = "UP";
const char* const NAME_EV_VOLUME = "VOLUME";
const char* const NAME_EV_VOLUME_SURFACE = "VOLUME_SURFACE";
const char* const NAME_EV_VOLUME_VOLUME = "VOLUME_VOLUME";
...
const char* const NAME_CV_DEFAULT_CHECKPOINTS_DIR = "DEFAULT_CHECKPOINTS_DIR";
const char* const NAME_CV_DEFAULT_COUNT_BUFFER_SIZE = "DEFAULT_COUNT_BUFFER_SIZE";
const char* const NAME_CV_DEFAULT_ITERATION_DIR_PREFIX = "DEFAULT_ITERATION_DIR_PREFIX";
const char* const NAME_CV_DEFAULT_SEED_DIR_DIGITS = "DEFAULT_SEED_DIR_DIGITS";
const char* const NAME_CV_DEFAULT_SEED_DIR_PREFIX = "DEFAULT_SEED_DIR_PREFIX";
const char* const NAME_CV_FLT_UNSET = "FLT_UNSET";
const char* const NAME_CV_ID_INVALID = "ID_INVALID";
const char* const NAME_CV_INT_UNSET = "INT_UNSET";
...
const char* const NAME_CV_RNG_SIZE = "RNG_SIZE";
