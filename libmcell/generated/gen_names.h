...
const char* const NAME_CLASS_SURFACE_AREA = "SurfaceArea";
...
const char* const NAME_AS_REGION = "as_region";
...
const char* const NAME_DIFFERENCE = "difference";
...
const char* const NAME_INTERSECT = "intersect";
...
const char* const NAME_PARENT = "parent";
...
const char* const NAME_SECOND_REGION = "second_region";
...
const char* const NAME_SURFACE_AREA = "surface_area";
const char* const NAME_SURFACE_AREAS = "surface_areas";
...
const char* const NAME_UNION = "union";
...
const char* const NAME_EV_LEAF_GEOMETRY_OBJECT = "LeafGeometryObject";
const char* const NAME_EV_LEAF_SURFACE_AREA = "LeafSurfaceArea";
const char* const NAME_EV_NONE = "None";
const char* const NAME_EV_NOT_SET = "NotSet";
const char* const NAME_EV_REGION_EXPR = "RegionExpr";
