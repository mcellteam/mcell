...
const char* const NAME_CLASS_VOLUME_COMPARTMENT = "VolumeCompartment";
...
const char* const NAME_ADD_VOLUME_COMPARTMENT = "add_volume_compartment";
...
const char* const NAME_GET_VOLUME_COMPARTMENT_REGION = "get_volume_compartment_region";
...
const char* const NAME_VOLUME_COMPARTMENTS = "volume_compartments";
