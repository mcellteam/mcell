...
const char* const NAME_CLASS_PARTITION = "Partition";
...
const char* const NAME_MOLECULE = "molecule";
...
const char* const NAME_SUBPARITION_DIMENSION = "subparition_dimension";
