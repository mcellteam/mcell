...
const char* const NAME_ABSORPTIVE = "absorptive";
...
const char* const NAME_REFLECTIVE = "reflective";
...
const char* const NAME_TRANSPARENT = "transparent";
...
const char* const NAME_EV_LEAF_SURFACE_REGION = "LeafSurfaceRegion";
