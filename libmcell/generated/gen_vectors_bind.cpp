...
void gen_vectors_bind(py::module& m){
  ...
  py::bind_vector<std::vector<std::vector<float_t>>>(m,"VectorVectorFloat");
  py::implicitly_convertible<py::list, std::vector<std::vector<float_t>>>();
  ...
  py::bind_vector<std::vector<float_t>>(m,"VectorFloat");
  py::implicitly_convertible<py::list, std::vector<float_t>>();
