...
py::class_<Subsystem> define_pybinding_Subsystem(py::module& m) {
  return py::class_<Subsystem, std::shared_ptr<Subsystem>>(m, "Subsystem")
      ...
      .def("add_species", &Subsystem::add_species, py::arg("s"), "- s\n")
      .def("find_species", &Subsystem::find_species, py::arg("name"), "- name\n")
      .def("add_reaction_rule", &Subsystem::add_reaction_rule, py::arg("r"), "- r\n")
      .def("find_reaction_rule", &Subsystem::find_reaction_rule, py::arg("name"), "- name\n")
      .def("add_surface_class", &Subsystem::add_surface_class, py::arg("sc"), "- sc\n")
      .def("find_surface_class", &Subsystem::find_surface_class, py::arg("name"), "- name\n")
      .def("add_elementary_molecule_type", &Subsystem::add_elementary_molecule_type, py::arg("mt"), "- mt\n")
      .def("find_elementary_molecule_type", &Subsystem::find_elementary_molecule_type, py::arg("name"), "- name\n")
