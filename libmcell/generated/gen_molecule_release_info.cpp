...
void define_pybinding_MoleculeReleaseInfo(py::module_& m) {
  py::class_<MoleculeReleaseInfo>(m, "MoleculeReleaseInfo", "Defines a pair (molecule, location). Used in ReleaseSite when its shape is Shape.LIST.\n")
      .def(
          py::init<
