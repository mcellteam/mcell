...
py::class_<Model> define_pybinding_Model(py::module& m) {
  return py::class_<Model, std::shared_ptr<Model>>(m, "Model")
      ...
      .def("find_release_site", &Model::find_release_site, py::arg("name"), "- name\n")
      ...
      .def("find_geometry_object", &Model::find_geometry_object, py::arg("name"), "- name\n")
      .def("find_volume_compartment_object", &Model::find_volume_compartment_object, py::arg("name"), "- name\n")
      .def("find_surface_compartment_object", &Model::find_surface_compartment_object, py::arg("name"), "- name\n")
