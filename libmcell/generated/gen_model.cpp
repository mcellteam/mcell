...
py::class_<Model> define_pybinding_Model(py::module& m) {
  return py::class_<Model, std::shared_ptr<Model>>(m, "Model")
      ...
      .def("load_bngl_molecule_types_and_reaction_rules", &Model::load_bngl_molecule_types_and_reaction_rules, py::arg("filename"))
      ...
      .def("load_bngl_seed_species", &Model::load_bngl_seed_species, py::arg("filename"), py::arg("subsystem"), py::arg("default_release_region") = nullptr)
      .def("add_viz_output", &Model::add_viz_output, py::arg("viz_output"))
      .def("add_count", &Model::add_count, py::arg("count"))
      .def("load_bngl_observables", &Model::load_bngl_observables, py::arg("filename"), py::arg("subsystem"), py::arg("output_files_prefix"))
      .def("dump", &Model::dump)
