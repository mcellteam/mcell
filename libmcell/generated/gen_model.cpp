...
py::class_<Model> define_pybinding_Model(py::module& m) {
  return py::class_<Model, std::shared_ptr<Model>>(m, "Model")
      ...
      .def("load_bngl", &Model::load_bngl, py::arg("file_name"), py::arg("observables_files_prefix"), py::arg("default_release_region") = nullptr)
      ...
      .def("load_bngl_observables", &Model::load_bngl_observables, py::arg("file_name"), py::arg("subsystem"), py::arg("output_files_prefix"))
      .def("dump", &Model::dump)
