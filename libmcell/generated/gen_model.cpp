...
void define_pybinding_Model(py::module_& m) {
  py::class_<Model>(m, "Model", "This is the main class that is used to assemble all simulation input \nand configuration. It also provides methods to do initialization,\nrun simulation, and introspect the running simulation.\n")
      .def(
          py::init<
          >()
      )
      ...
      .def("add_subsystem", &Model::add_subsystem, py::arg("subsystem").none(), "Adds all components of a Subsystem object to the model.\n- subsystem\n")
      .def("add_instantiation", &Model::add_instantiation, py::arg("instantiation").none(), "Adds all components of an Instantiation object to the model.\n- instantiation\n")
      .def("add_observables", &Model::add_observables, py::arg("observables").none(), "Adds all counts and viz outputs of an Observables object to the model.\n- observables\n")
      ...
      .def("add_species", &Model::add_species, py::arg("s").none(), "Add a reference to a Species object to the species list.\n- s\n")
      ...
      .def("add_reaction_rule", &Model::add_reaction_rule, py::arg("r").none(), "Add a reference to a ReactionRule object to the reaction_rules list.\n- r\n")
      ...
      .def("add_surface_class", &Model::add_surface_class, py::arg("sc").none(), "Add a reference to a SurfaceClass object to the surface_classes list.\n- sc\n")
      ...
      .def("add_elementary_molecule_type", &Model::add_elementary_molecule_type, py::arg("mt").none(), "Add a reference to an ElementaryMoleculeType object to the elementary_molecule_types list.\n- mt\n")
      ...
      .def("add_release_site", &Model::add_release_site, py::arg("s").none(), "Adds a reference to the release site s to the list of release sites.\n- s\n")
      ...
      .def("add_geometry_object", &Model::add_geometry_object, py::arg("o").none(), "Adds a reference to the geometry object o to the list of geometry objects.\n- o\n")
      ...
      .def("get_vertex", &Model::get_vertex, py::arg("object").none(), py::arg("vertex_index"), "Returns coordinates of a vertex.\n- object\n- vertex_index: This is the index of the vertex in the geometry object's walls (wall_list).\n\n")
      .def("get_wall", &Model::get_wall, py::arg("object").none(), py::arg("wall_index"), "Returns information about a wall belonging to a given object.\n- object: Geometry object whose wall to retrieve.\n\n- wall_index: This is the index of the wall in the geometry object's walls (wall_list).\n\n")
      .def("get_vertex_unit_normal", &Model::get_vertex_unit_normal, py::arg("object").none(), py::arg("vertex_index"), "Returns sum of all wall normals that use this vertex converted to a unit vector of \nlength 1 um (micrometer).\nThis represents the unit vector pointing outwards from the vertex.\n\n- object: Geometry object whose vertex to retrieve.\n\n- vertex_index: This is the index of the vertex in the geometry object's vertex_list.\n\n")
      .def("get_wall_unit_normal", &Model::get_wall_unit_normal, py::arg("object").none(), py::arg("wall_index"), "Returns wall normal converted to a unit vector of length 1um.\n- object: Geometry object whose wall's normal to retrieve.\n\n- wall_index: This is the index of the vertex in the geometry object's walls (wall_list).\n\n")
      .def("get_wall_color", &Model::get_wall_color, py::arg("object").none(), py::arg("wall_index"), "Returns color of a wall.\n- object: Geometry object whose wall's color to retrieve.\n\n- wall_index: This is the index of the vertex in the geometry object's walls (wall_list).\n\n")
      .def("set_wall_color", &Model::set_wall_color, py::arg("object").none(), py::arg("wall_index"), py::arg("color").none(), "Sets color of a wall.\n- object: Geometry object whose wall's color to retrieve.\n\n- wall_index: This is the index of the vertex in the geometry object's walls (wall_list).\n\n- color: Color to be set.\n\n")
      .def("dump", &Model::dump)
      .def_prop_rw("config", &Model::get_config, &Model::set_config, "Simulation configuration.")
      .def_prop_rw("warnings", &Model::get_warnings, &Model::set_warnings, "Configuration on how to report warnings.")
      .def_prop_rw("notifications", &Model::get_notifications, &Model::set_notifications, "Configuration on how to report certain notifications.")
      .def_prop_rw("species", &Model::get_species, &Model::set_species, py::rv_policy::reference, "List of species to be included in the model for initialization.\nUsed usually only for simple species (species that are defined using a\nsingle molecule type without components such as 'A').\nOther species may be created inside simulation  \n")
      .def_prop_rw("reaction_rules", &Model::get_reaction_rules, &Model::set_reaction_rules, py::rv_policy::reference)
      .def_prop_rw("surface_classes", &Model::get_surface_classes, &Model::set_surface_classes, py::rv_policy::reference)
      .def_prop_rw("elementary_molecule_types", &Model::get_elementary_molecule_types, &Model::set_elementary_molecule_types, py::rv_policy::reference, "Contains list of elementary molecule types with their diffusion constants and other information. \nPopulated when a BNGL file is loaded and also on initialization from Species objects present in \nthe species list.\n")
      .def_prop_rw("release_sites", &Model::get_release_sites, &Model::set_release_sites, py::rv_policy::reference, "List of release sites to be included in the model.  \n")
      .def_prop_rw("geometry_objects", &Model::get_geometry_objects, &Model::set_geometry_objects, py::rv_policy::reference, "List of geometry objects to be included in the model.  \n")
      .def_prop_rw("checkpointed_molecules", &Model::get_checkpointed_molecules, &Model::set_checkpointed_molecules, py::rv_policy::reference, "Used when resuming simulation from a checkpoint.\n")
      .def_prop_rw("viz_outputs", &Model::get_viz_outputs, &Model::set_viz_outputs, py::rv_policy::reference, "List of visualization outputs to be included in the model.\nThere is usually just one VizOutput object.   \n")
      .def_prop_rw("counts", &Model::get_counts, &Model::set_counts, py::rv_policy::reference, "List of counts to be included in the model.\n")
    ;
}
