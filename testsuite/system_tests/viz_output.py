...
###################################################################
# Give an error if the specified RK mode viz file is invalid, according to the
# specified parameters.
#
# Parameters:
#      fname        - the filename to check
...
###################################################################
# Give an error if the specified DREAMM V3 (non-grouped) mode viz output set is
# invalid, according to the specified parameters.  This only checks the
...
# Parameters:
#      dir              - the directory containing the output files
#      alliters         - sorted iteration numbers where any output was
#                         produced
...
#      positers     - iteration numbers where mesh pos output was produced, if
#                     different from alliters
#      regioniters  - iteration numbers where region data output was produced,
#                     if different from alliters
#      stateiters   - iteration numbers where mesh state was produced, if any
#                     (it is assumed that no mesh state data was produced,
#                     otherwise)
